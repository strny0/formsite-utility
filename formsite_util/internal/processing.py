...
class _FormsiteProcessing:
    ...
    def Process(self) -> pd.DataFrame:
        ...
        if isinstance(self.interface.params.last, int) and final_dataframe.shape[0] > self.interface.params.last:
            final_dataframe = final_dataframe.iloc[:self.interface.params.last]
